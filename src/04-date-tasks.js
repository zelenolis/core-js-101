...
function timeSpanToString(startDate, endDate) {
  ...
  const minutes = Math.floor(dif / (1000 * 60) - hours * 60);
  const seconds = Math.floor(dif / (1000) - hours * 60 * 60 - minutes * 60);
  const milliseconds = Math.floor(dif - hours * 60 * 60 * 1000
